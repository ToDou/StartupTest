package com.test.tudou.startuptest.ui.view.shapeview.shader;
    ...
    public void calculate(int bitmapWidth, int bitmapHeight,
        ...
        switch (arrowPosition) {
            case LEFT:
                ...
                path.moveTo(rectLeft + scaledTriangleHeight, centerY);
                path.lineTo(rectLeft, centerY - scaledTriangleHeight);
                path.lineTo(rectLeft, centerY + scaledTriangleHeight);
                path.lineTo(rectLeft + scaledTriangleHeight, centerY);
                break;
            case RIGHT:
                rectLeft = x;
                ...
                path.addRect(rectLeft, y, rectRight, resultHeight + y, Path.Direction.CW);
                path.moveTo(rectRight - scaledTriangleHeight, centerY);
                path.lineTo(rectRight, centerY - scaledTriangleHeight);
                path.lineTo(rectRight, centerY + scaledTriangleHeight);
                path.lineTo(rectRight - scaledTriangleHeight, centerY);
                break;
